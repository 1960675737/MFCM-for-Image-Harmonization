...
def init_experiment(args):
    ...
    # if cfg.dropout_depth != '':
    #     cfg.dropout_depth = [int(id) for id in cfg.dropout_depth.split(',')]
    # else:
    #     cfg.dropout_depth = None
    ...
    cfg.teacher_device = torch.device(f'cuda:{cfg.gpu_ids[0]}')
